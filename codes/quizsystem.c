...
int main()
     ...
     printf("\n\t\t****************************************");
     printf("\n\t\t****************************************");
     printf("\n\t\t   BECOME A MILLIONAIRE!!!!!!!!!!! BY ANSWERING CORRECT    ") ;
     printf("\n\t\t****************************************");
     printf("\n\t\t****************************************");
    ...
    printf("\n\n\n\n\n\n\n\n\n\n\t\t\tYour name please:");
     gets(playername);
    system("cls");
    printf("\n ******************  We Welcome %s to C Program Quiz Game **************************",playername);
    printf("\n\n Here are some tips you might want to know before start playing:");
    printf("\n *************************************************************************");
    printf("\n >> There are 2 rounds in this Quiz Game,Skill ROUND & Main ROUND");
    printf("\n >> In Skill round you will be asked a total of 3 questions to test your");
...
game:
     ...
     switch(r)
		{
		case 1:
		printf("\n\nWhat country has the second highest life expectancy?");
		printf("\n\nA.Hongkong\t\tB.China\n\nC.Japan\t\tD.USA");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;
		    ...
		    {
		        printf("\n\nWrong!!! The correct answer is C.Japan");
				getch();
		        break;
		    }
		case 2:
		printf("\n\n\nWhat game studio made the game LA. Noire");
		printf("\n\nA.Ubisoft\t\tB.BlizzardGames\n\nC.Rockstar Games\t\tD.Vaulted Sky Games");
		if (toupper(getch())=='C')
			{
				printf("\n\nCorrect!!!");count++;
				getch();
		    ...
		    {printf("\n\nWrong!!! The correct answer is C.Rockstar Games");
		    getch();
		    break;
			}
		case 3:
		printf("\n\n\nWhat character have both Robert Downey Jr. and Benedict Cumberbatch played?");
		printf("\n\nA.Sherlock Holmes\t\tB.Iron Man\n\nC.Doctor Strange\t\tD.Stephen Hawking");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Sherlock Holmes");
		       getch();
		       break;}
        case 4:
        ...
        if (toupper(getch())=='B')
		       ...
		       break;}
		case 6:
		printf("\n\n\nWhat is the group of bees known as?");
		printf("\n\nA.Colonies\t\tB.Toddler\n\nC.Police\t\tD.Army");
		if (toupper(getch())=='A' )
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Colonies");
		       getch();
		       break;}}
		       }
        case 7:
		...
		printf("\n\nA.Red Wine\t\tB.Beer\n\nC.Whiskey\t\tD.Port Wine");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch(); break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Red Wine");getch();
			   goto score;
			   break;}
        case 11:
		...
		if (toupper(getch())=='A')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is A.Horse");getch();goto score;
		       break;}
		...
		case 20:
		printf("\n\n\nWhich of the follwing is the First microprocessor to be invented?");
		printf("\n\nA.8085\t\tB.ARM\n\nC.Intel 4004\t\tD.8008");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++; getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Intel 4004");getch();goto score;
		       break;}
		...
		case 22:
		printf("\n\n\nThe number 0 was invented in which country");
		printf("\n\nA.Greece\t\tB.China\n\nC.Britain\t\tD.India");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");countr++; getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is D.India");getch();goto score;
		       break;}
